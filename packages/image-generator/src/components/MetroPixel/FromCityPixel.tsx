      ...
      {times.map((time: Departures, idx: number) => (
        <Box key={idx} border="pixel" p={2} flex="1">
          <HStack gap={2} align="center" justify="space-between">
            ...
            {/* Minutes */}
            <Box border="pixel" px={2} py={1} bg="pixel.background" minW="60px" textAlign="center">
              <Text fontSize="xl" color="pixel.darkest">
                {time.estimated}m
              </Text>
            </Box>
