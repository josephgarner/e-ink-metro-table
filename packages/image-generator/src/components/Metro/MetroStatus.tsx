...
import './MetroStatus.css'
import { TrainsToCity } from './toCity'
  ...
  return (
    <div className="container">
      <div className="container-row">
        <span
          className="padded-span black-border"
        ...
        <span className="padded-span black-border">Flinders</span>
      </div>
      <div className="container-row">
        <ErrorBoundary>
      ...
      <div className="container-row">
        <span className="padded-span black-border">Home</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="30"
          height="30"
